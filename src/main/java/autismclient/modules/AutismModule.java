...
public final class AutismModule {
    ...
    public void tick() {
        ...
        if (!PackHideState.isActive() && PackModuleRegistry.hasTickWork()) {
            perf = AutismPerf.beginJoin();
    ...
    public void onGameJoin() {
        ...
        if (!PackHideState.isActive()) PackModuleRegistry.onGameJoin();
    ...
    public void onGameLeft() {
        ...
        if (!PackHideState.isActive()) PackModuleRegistry.onGameLeft();
    ...
    public void appendTooltip(ItemStack stack, List<?> lines) {
        PackModuleRegistry.appendTooltip(stack, lines);
    }
