...
public final class BoatFlyModule extends PackModule {
    ...
    public BoatFlyModule() {
        ...
        option(PackModuleOption.bool("change-forward-speed", "Change Forward Speed", false)
            .description("Use custom forward speed.").build());
        option(PackModuleOption.decimal("forward-speed", "Forward Speed", 1.0, 0.05, 5.0, 0.05)
            .visible(module -> module.bool("change-forward-speed"))
            .description("Sets forward speed.").build());
        option(PackModuleOption.decimal("upward-speed", "Upward Speed", 0.3, 0.0, 5.0, 0.05)
