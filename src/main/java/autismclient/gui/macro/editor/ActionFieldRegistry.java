...
public final class ActionFieldRegistry {
    ...
    static {
        ...
        SCHEMAS.put(MacroActionType.CAPTURE_VALUE, ActionFieldSchema.builder()
                .enumField("source", "Read From", "GUI_TITLE", "RECENT_CHAT", "SCOREBOARD", "GUI_ITEM", "PLAYER_ITEM", "CURSOR_ITEM", "HELD_ITEM")
                ...
                .toggle("normalizeNumbers", "Normalize Number")
                .enumField("numberModifier", "Modifier", "NONE", "PLUS", "MINUS", "MULTIPLY", "DIVIDE")
